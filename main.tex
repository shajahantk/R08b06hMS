...
effect observed in bacteria. For instance, a droplet containing 
...
indicate that one can tune the dynamics and interactions of these droplets by varying the concentration of sodium bromate.
...
decreases. Furthermore, when two droplets with different oscillation frequencies interact, the interaction time is determined by the droplet with the higher activity.

\section{Methods}

We conducted experiments at room temperature ($24^{\circ}$) temperature, 
...
monoolein-squalane oil medium in a 5cm diameter S-line Petri dish, to
...
When BZ droplets are placed in a Petri dish with a lower density
