...
placed in a Petri dish filled with oily medium (figure~\ref{fig:setup}(a)), soon 
it starts moving on the 2D surface of the Petri dish. A typical trajectory of the droplet
is shown in  figure~\ref{fig:setup}(b). The self-propelled
motion of the BZ droplet is associated with chemical oscillations inside the BZ
droplet and interfacial tension around the droplet. The chemical oscillations can be 
seen as color change in the droplet. We show the average light intensity as a function of 
time in figure~\ref{fig:setup}(c). The chemical waves can also be seen propagating from one end 
of the droplet (figure~\ref{fig:setup}(d)).

In this work, we measure the dynamics of
the BZ droplet as a function of sodium bromate. Figure
\ref{fig:activity}(a-c), show the trajectory of the BZ droplet at
varying sodium bromate concentrations. As the sodium bromate concentration
increases in the BZ droplet, the droplet's trajectory becomes more complex. We quantify the
complexity of the movement using the frequency of oscillations inside the droplet, fluctuations 
in the movement direction, and the speed of the droplet.
We tracked the average color intensity of moving BZ droplets as discussed in the
method. From this time series, we can calculate the average frequency of chemical
oscillations. The frequency of chemical
oscillations increases with the sodium bromate
concentration (figure~\ref{fig:activity}(d)).  In Figure
\ref{fig:activity}~(e), it is visible that the fluctuation in direction increases
with sodium bromate. The instantaneous speed of the droplet also increases 
with the sodium bromate concentration. Thus we can control the movement patterns of the BZ droplet by varying 
the sodium bromate concentration.
In all these studies the volume is fixed at \todo{Give volume}.
...
We measure the interaction time of the two BZ droplets as a function of
sodium bromate concentration. First, we study the
interaction of two chemically identical BZ droplets, in which both
interacting BZ droplets have the same sodium bromate concentration. 
Figure \ref{fig:dropletDistance}(d), blue bars (marked A) indicate the interaction
time of identical BZ droplets. This time decreases with the sodium bromate
concentration. We also measured the interaction time of the BZ droplets
when sodium bromate concentrations are different in them. We fixed the sodium
bromate concentration in one BZ droplet and varied the concentration 
in the second droplet. In Figure \ref{fig:dropletDistance}(d), the red bars (marked B), 
show the variation of interaction time when sodium bromate concentration is
varied only in the second droplet. We note that the mean interaction time 
decreases with sodium bromate, however, the change is less compared to A.
It indicates that when two
...
behind a smaller one (see figure \ref{Different_size}a, b, c respectively). 
The speed of droplets depend on the size~\cite{???}.
\todo{Is there a reference for size dependence? Can we add a figure?}
Larger BZ droplets move than the smaller BZ droplet. The interaction time is 
highest when a large droplet follows a small one (as in figure \ref{Different_size}~c). 
The speed large droplet is suppressed by the smaller droplet, leading to a sustained
interaction for a long time (figure \ref{Different_size}). In other situations (figure \ref{Different_size}~a and b)
the interactions are shorter. The interaction times in three different patterns of movement
are shown in figure~\ref{fig:Big-Small}.
\begin{figure}[H]
    \centering
