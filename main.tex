...
The Self-propelled motion is a very important characteristic of
biological systems \cite{rosing2005thermodynamics}. It is true for
everything from single-cell microorganisms to large and most complex
mammals \cite{francis2017electrotactic}. These self-propelled systems
can harness energy from their immediate environment and transform it
into mechanical energy. This mechanism is important for mobility and
allows them to move in a specific direction
\cite{dixit2023pathway}. In recent years, scientists have shown a lot
of interest in developing a system that can mimic the life-like
behavior or characteristics of the biological system by using
nonliving matter. For example, Colloidal particles move in a \ch{H2O2}
solution \cite{yao2012nanostructured} \cite{gao2013organized}, while
solid particles or oil droplets are propelled by differences in
interfacial tension \cite{bánsági2013motion}. Additionally, oil or
aqueous droplets can self-propel due to the Marangoni
effect\cite{toyota2009self},\cite{thutupalli2011swarming},
\cite{suematsu2016oscillation}.

\par The Belousov-Zhabotinsky reaction is more extensively used to
mimic the behavior observed in biological organisms because of its
nonlinear nature. The BZ reaction is a nonlinear chemical oscillatory
reaction; in this reaction, oscillations can be observed in the form
of a color change. In the beginning years, these reactions were widely
used to produce target and spiral patterns \cite{amrutha2022mechanism}
\cite{amrutha2023theory} \cite{sebastian2024effect}, which are similar
to patterns observed to some extent with biological excitable media
such as the heart \cite{luther2011low}, \cite{diagne2023rhythms},
brain \cite {huang2004spiral}, retina \cite{yu2012reentrant}, and
communication of waves in amoeba Dictyostelium discoideum
\cite{noorbakhsh2015modeling}, \cite{kamino2017fold}.
\par In the last few years, researchers started using the BZ reaction
to study the self-propelled motion of active droplets to make a system
that can mimic the characteristic behavior of a microbiological
system, such as run and tumble motion \cite{suematsu2021spontaneous}
and the electrotaxis effect\cite{back2023electrotaxis}. Oliver et al
\cite{steinbock1998radius} first studied the BZ droplet; after that,
lots of work has been done on the self-propelled motion of the BZ
droplet in oil medium\cite{kitahata2011spontaneous},
\cite{suematsu2016oscillation}, \cite{kumar2021fast},
\cite{suematsu2021spontaneous}. The collective interaction of the
active droplets is always an interesting topic for researchers because
certain bacteria, microorganisms, or cells give a response to the
presence of a certain chemical gradient and either move toward or away
from it \cite{ray2024experimental}. In the collective interaction of
the BZ droplet, researchers studied the chemical communication between
the BZ droplet inside the capillary tube \cite{delgado2011coupled},
\cite{li2014combined}, and in the array \cite{chang2018towards}. In
this experimental work, we first reported the binary interaction of BZ
droplets moving in a random direction. In this work, we explored the
interaction and collective behavior of two BZ droplets with the
activity of the BZ droplets.
%\newpage

\section{Methodology}
We performed experiments at room temperature under the same
environmental conditions. The concentration of the components of the
Belousov-Zhabotinsky reaction was 0.48M to 0.96M \ch{NaBrO_3} with the
0.5M \ch{H_2SO_4}, malonic acid 0.96M, NaBr 0.97M. We used a 25mM
ferroin indicator solution as a metal catalyst in the BZ reaction. The
Belousov-Zhabotinsky reaction was performed on the magnetic stirrer
with continuous stirring up to the first oscillation of the BZ
reaction. The 10mM monoolein-squalane oil medium was used in the 5cm
diameter S-Line petri dish to study the self-propelled motion and
interaction of the BZ droplet. The 2$\mu$L droplet was prepared using
a micropipette. The BZ droplet motion was recorded using a CMOS camera
controlled by the LabVIEW program. Images recorded with the five fps
and analyzed using ImageJ software and Python programs. The total
number of droplets used to study was more than 300.
...
\begin{figure}[H]
    ...
    \caption{\textbf{Experimental Setup:} Figure illustrates the
      ...
      micropipette. The images are captured with a CMOS camera and
      transferred to a computer for further analysis. (b) Trajectory
      of the BZ droplet in Mo-Sq oil medium. (c) The color
      oscillations inside the droplet are plotted as the average blue
      color intensity (in arbitrary units a.u.) of the BZ droplet as a
      function of time.}
...
a 10mM monoolein-squalane oil medium, the droplet moves in a random
direction. Inside the Belousov-Zhabotinsky reaction droplet,\ch{Br^-}
ions are generated from the sodium bromate in an acidic medium, which
is helpful in the BZ reaction for oscillation. These emitted \ch{Br^-}
ions also react with the monoolein present in the oil and form the
bromomonoolein layer at the interface of the BZ droplet. It leads to a
reduction in interfacial tension around the BZ droplet, and the BZ
droplet moves from lower interfacial tension to higher interfacial
tension.
...
The emission of \ch{Br^-} ions increases with the sodium bromate in
the Belousov-Zhabotinsky reaction. We performed experiments for the BZ
droplets with sodium bromate at concentrations of 0.48M to 0.96M. The
oscillatory reaction rate increased with sodium bromate, which leads
to an increase in the frequency of oscillation and concentration of
\ch{Br^-} ions. At the BZ droplet's surface, the bromination rate of
monoolein also increased. It increases the speed of the BZ droplet
with sodium bromate. It is also observed that the continuous
fluctuations in the direction of self-propelled motion of the BZ
droplet increase with sodium bromate. In Figure \ref{Activity}, we can
observe that the frequency of oscillations, direction fluctuations,
and droplet speed increase with the sodium bromate. Hence, the BZ
droplet exhibits higher active behavior with a higher sodium bromate
concentration.
...
other, also droplets moved together while keeping the inter-droplet
distance of 2.5 or less(ref video). While touching each other's
boundaries, coalescence behavior was not observed due to the
bromomonoolein layer on the surface of the BZ droplet. In this
experimental work, we explored the interaction of the BZ droplets with
the sodium bromate concentration. In Figure \ref{BZ Droplet
  Interaction Trajectory}, we can observe the interaction of two BZ
droplets with different sodium bromate concentrations at different
times and positions of the droplets.
% \begin{figure}[H]
%   \centering
...
We were also interested to know about the interactions of BZ droplets
with different active behaviors. For that, we explored the interaction
of the BZ droplet with different sodium bromate concentrations. We
fixed the concentration of sodium bromate in one droplet and varied it
in the other droplet. We observed the same behavior as in Figure
\ref{H2SO4+NaBrO3_Combined_fit} (a), the interaction time decreases as
the sodium bromate concentration of the other BZ droplet
increases. The interaction time of the BZ droplets with different
sodium concentrations depends on the droplet with a higher sodium
...
Similarly, we explored the interaction of droplets with different
sizes. We observed the three types of interaction depending on the
arrival of both droplets in interaction. The droplets arrive from
opposite sides, the droplets move in parallel, and the big droplet
follows the small droplet. The big droplet has a higher surface area
compared to the smaller droplet. Hence, the bromination rate of
monoolein was higher in the big BZ droplet. It leads to a higher speed
for the big droplet than for the smaller droplet. When a small droplet
arrives from the opposite direction, or both droplets move parallel
with maintaining a minimum distance, a shorter interaction time is
achieved than when a big droplet follows the small droplet. When a big
droplet follows a small droplet, the big droplet's speed gets
suppressed by the small droplet, and this interaction was sustained
for a long time. These three types can be observed in Figure
...
The interaction time of the droplet when two droplets arrive from
opposite direction and moved parallel then the interaction time of the
droplets was less than 50 seconds. These interactions are presented in
the shaded region in the Figure \ref{Big-Small Droplet Interaction
  Time}. In the other part of the figure, the droplet interaction time
of more than 50 seconds is the droplet interaction when the big
droplet follows the small droplet. The interaction time when the small
droplet follows the big droplet was negligible. The big droplet has a
higher speed than the small droplet. When a small droplet followed the
big droplet, it did not sustain. When two droplets of the same size
interact, the interaction time is independent of which side the
droplets arrive. The collective interaction of the BZ droplet was
observed for the 2.5mm or less inter-droplet distance for the 1.75mm
diameter of the BZ droplets.
%\begin{figure}[H]
%  \centering
...
droplet increase as a function of sodium bromate. It shows that the
...
droplet from a long distance, it is still an open question. We hope
