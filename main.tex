...
Many living and non-living systems, as simple as single cells and small
droplets of liquid, can harness energy from the surrounding and use it
to propel themselves~\cite{rosing2005thermodynamics, dixit2023pathway}.
The self-propelled motion of droplets often mimic important features of 
movements in the unicellular organisms.
For example, Colloidal particles move in a \ch{H2O2}
...
\cite{suematsu2016oscillation}. \todo[inline]{It would be interesting if we 
could comment on how these studies show parallel between biological behaviour 
and droplets}. 

One important class of chemically driven active particles contains 
...
chemical waves, creating circular and spiral patterns~\cite{amrutha2022mechanism}
\cite{amrutha2023theory} \cite{sebastian2024effect}.
Many studies have shown that such chemical waves can affect the 
direction and magnitude of the self-propelled motion in these droplets~\cite{???}.

Recently many groups have explored BZ reaction droplets
to study the run and tumble motion \cite{suematsu2021spontaneous}
and their reaction to external electric field\cite{back2023electrotaxis}
or chemical gradients~\cite{ray2024experimental}. 

Oliver {\it et al.}~\cite{steinbock1998radius} first studied the BZ droplet; after that,
...
\todo[inline]{If the following works are important for this paper, please metion what each one has done and then cite them. See above}.
For example, such droplets can communicate via chemical signals~\cite{delgado2011coupled, li2014combined,chang2018towards}. 

In this paper, we study the interaction between two BZ
droplets. We find that such interaction can be tuned by 
the chemical activity of each individual droplets.
