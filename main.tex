...
\section{Methods}
We have used the aqueous droplets of BZ reaction mixture in 
...
about color oscillations. If needed a schematic can be added to figure 2.}
...
Petri dish inside the oily medium. The dynamics of chemical oscillation and 
the subsequent movement of the droplet can be controlled by the 
bromate concentration ???. Figure~\ref{fig:activity}~a shows the dynamics of
chemical waves within the droplet \todo{please produce a sequence of images}.
...
We investigate the characteristics of the movement of BZ droplets as we
vary sodium bromate concentrations.
As the concentration of
sodium bromate increases, the BZ droplet’s trajectory becomes
increasingly complex (see figure~\ref{fig:activity}~(a-c)).
With higher sodium bromate
...
experiment\todo{This is very crude. Can you use time series and 
cross check the frequency}. 
Figure~\ref{fig:activity}(d) shows that the oscillation
...
concentration. Figure~\ref{fig:activity}(e)??? shows that 
directional fluctuations also increase
with sodium bromate concentration. We also measure the droplet speed
and find that droplet speed also increases with sodium bromate.
This confirms that BZ droplets
...
different droplets move in different directions.
But we observe that droplets often discover other droplet, come closer to 
it, and move around or moved parallel for some time, and then move away (see figure~\ref{fig:tango}).
...
droplets) was 2.5mm or less.\todo{Is this true irrespective of the size of the droplets?}
(See supplementary videos). The bromo-mono-olein layer \todo{Check if the name is correct?} that forms around each droplet
in the squalein-monolein medium can prevent the droplets from merging~\cite{thutupalli2011bilayer}.
...
\todo{Change these figures into a hostogram. Figs 4,6,7 can be combined}.
...
another. We observed three distinct types of dynamics based on how
...
interaction for long time (figure \ref{Different_size}).
\begin{figure}[H]
    \centering
...
\todo{figure \ref{fig:Big-Small} is very vague. Use different symbols for each of the three 
types of interactions. What does the y-axis signify?}
...
Figure \ref{fig:Big-Small}. Conversely, in other
...
\section{Discussion}
\todo{Please try to explain our results- why the droplets come closer and stay together and move away. What happens as bromine concentration increases. Each new statement should have citations.}
