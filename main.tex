...
\todo{Don't you find the circular motion here?}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figurs/Barplot.pdf}
    \caption{\textbf{Interaction Time between big and small droplets:} 
	The plots present the interaction time of the interactions among the
