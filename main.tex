...
bromate. Figure \ref{fig:activity}(a-c) shows the trajectory of the BZ droplet
...
with different activity levels ( {\it i.e.,} with different sodium bromate
concentrations) interact, the interaction time depends on the BZ droplet with
the higher activity or sodium bromate concentration.
...
function of chemical activity (by varying sodium bromate concentration) and 
...
The interaction time decreases with chemical activity in either or both droplets.
