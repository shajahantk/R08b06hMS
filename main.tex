...
inwhich the two droplets stay in close proximity. The 
interaction time
...
We tracked the inter-droplet distance (Distance between the
center of the BZ droplet) of the two interacting BZ droplets
(figure~\ref{Inter-Droplet Distance}). The
